...
/** Builds the focused Reference experiment menu beside the canonical framework tools. */
public final class ReferenceExperimentTesters {
    private ReferenceExperimentTesters() {
    }
    ...
    public static TesterSuite create() {
        ...
        suite.add("Flywheel spin-up",
                ...
                () -> new ReferenceFlywheelSpinUpExperiment(
                        ReferenceFlywheelMechanism.Config.defaults(), criteria));
