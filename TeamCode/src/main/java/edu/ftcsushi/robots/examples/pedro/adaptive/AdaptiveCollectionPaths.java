 ...
 * route factory runs. Selected targets are converted from Sushi field coordinates; unavailable
...
public final class AdaptiveCollectionPaths {
    ...
    public static final class Config {
        ...
        /** Selected-band target X in the Sushi FTC field frame, in inches. */
        public double collectionFieldXInches;
        /** Selected-band target heading in the Sushi FTC field frame, in radians. */
        public double collectionFieldHeadingRad;
        /** No-selection fallback target in the Sushi FTC field frame. */
        public Pose2d fallbackFieldToRobotPose;
        /** Return target in the Sushi FTC field frame. */
    ...
    private static PathBuilder routeBuilder(PedroPathingRuntime runtime,
                                            Config config,
                                            Pose2d sushiFieldTarget) {
        Pose start = Objects.requireNonNull(
                runtime.currentPedroPose(),
                "runtime.currentPedroPose()"
        );
        Pose target = config.fieldTransform.sushiFieldToPedroPose(sushiFieldTarget);
    ...
    /** Copies one finite immutable Sushi-field pose. */
