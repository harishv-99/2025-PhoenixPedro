...
-   :material-book-open-variant: **Reference**
    ...
    Look up a framework family, exact API type, method, unit, or lifecycle contract.

    [Open the reference](<docs/reference/README.md>)

</div>

## Search scope

**Search all guides** searches all six areas, even while one tab is open. Filter results with the
