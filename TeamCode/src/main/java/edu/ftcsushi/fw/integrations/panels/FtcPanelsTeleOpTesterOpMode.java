...
/**
 * Panels boundary for a Sushi tester OpMode with mirrored telemetry and one fixed input owner.
 *
 ...
 * boundary. The joined sink supports the ordinary row operations used by Sushi testers; it is
