 ...
 *
 * <p>This is Sushi's principled replacement for "action controllers" that directly write hardware.
 ...
 * current output as a {@link edu.ftcsushi.fw.core.source.ScalarSource}.</p>
 *
...
public interface OutputTask extends Task {
     ...
     *   <li>Should reflect the most recent {@link #update(edu.ftcsushi.fw.core.time.LoopClock)} call.</li>
