 ...
 *
 * <p>Sushi intentionally keeps the vision boundary narrow: an {@code AprilTagSensor}
...
public interface AprilTagSensor extends Source<AprilTagDetections> {
     ...
     * {@link AprilTagDetections#fromFrame(edu.ftcsushi.fw.core.time.LoopTimestamp,
