 ...
 *
 * <p>This is not a Sushi {@code Source<T>}: the consuming Plant must supply the
 ...
 * {@link PlantTargets#equivalentPositionsOf(edu.ftcsushi.fw.core.source.ScalarTarget)} for the
 ...
 * {@link PlantTargets#plan(edu.ftcsushi.fw.core.source.Source)} for live request sources.</p>
 *
