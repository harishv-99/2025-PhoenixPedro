 ...
 *
 * <p>Sushi is built around a single loop heartbeat ({@link LoopClock}). Sources make that
...
public interface Source<T> {
     ...
     * Optional debug hook.
     *
     * <p>Follow Sushi conventions: if {@code dbg} is null, do nothing. Use stable keys.
     ...
     *
     * <p>This is Sushi's generic "remember across samples" primitive for value-object sources.
