package edu.ftcsushi.fw.core.geometry;

import java.util.Objects;

/**
 * Immutable 3D pose (6-DOF) in Sushi's standard right-handed coordinate conventions.
 *
 ...
 *       <li><b>Robot/mechanism frames</b> in Sushi are typically expressed as +X forward,
 *           +Y left, +Z up.</li>
 *       <li><b>Field-centric poses</b> in Sushi are expressed in the <b>FTC Field Coordinate
...
public final class Pose3d {
    ...
    /**
     * Translation component as a {@link Vec3} (inches, Sushi axes).
     */
    ...
    /**
     * Rotation component as a {@link Mat3}, using Sushi yaw-pitch-roll convention.
     */
