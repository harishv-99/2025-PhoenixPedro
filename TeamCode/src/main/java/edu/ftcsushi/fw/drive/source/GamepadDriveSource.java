package edu.ftcsushi.fw.drive.source;
 ...
 * </p>
 *
 * <h2>Sushi sign conventions</h2>
 * <p>{@link DriveSignal} uses Sushi conventions:</p>
 * <ul>
 ...
 * {@link edu.ftcsushi.fw.ftc.input.GamepadDevice GamepadDevice} adapter. This source itself
 * receives only Sushi scalar and boolean sources.</p>
 *
 * <pre>{@code
...
public final class GamepadDriveSource implements DriveSource {
    ...
    public static final class Config {
        ...
        /**
         * Creates a config populated with Sushi defaults.
         *
