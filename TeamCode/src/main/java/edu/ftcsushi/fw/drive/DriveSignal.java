...
/**
 * Immutable robot-centric drive command used throughout the Sushi framework.
 *
 ...
 * (not field-centric), and aligned with Sushi pose conventions
 ...
 *
 * <p>
 * These conventions are implemented by {@link edu.ftcsushi.fw.drive.MecanumDrivebase}.
 * Driver-facing inputs (gamepad sticks) are converted at the boundary (see
 * {@link edu.ftcsushi.fw.drive.source.GamepadDriveSource}) so that:
 * </p>
 *
 * <ul>
 ...
 * {@link edu.ftcsushi.fw.drive.DriveSource} (such as
 * {@link edu.ftcsushi.fw.drive.source.GamepadDriveSource}) and feed its output into
 * a drivebase (such as {@link edu.ftcsushi.fw.drive.MecanumDrivebase}):</p>
 *
 * <p>The example obtains its input sources through the FTC-boundary
 * {@link edu.ftcsushi.fw.ftc.input.GamepadDevice GamepadDevice} and
 * {@link edu.ftcsushi.fw.ftc.input.Gamepads Gamepads} adapters.</p>
 *
 * <pre>{@code
 ...
 * {@link edu.ftcsushi.fw.drive.DriveSource} implementations that still produce
