...
/**
 * Minimal Sushi-owned seam for following an external route object.
 *
 * <p>This interface exists for lane-5 integrations such as Pedro Pathing, Road Runner, or a
 * team-owned follower. Sushi intentionally does <b>not</b> define the route type itself. The
 ...
 *
 * <p>The goal is the same as {@link edu.ftcsushi.fw.drive.DriveCommandSink}: keep framework code
 ...
 * implementation must be cycle-idempotent so both callers are safe. Sushi production Pedro code
