 ...
 * <b>"up" is always positive</b> in Sushi code. X-axis values are passed through as-is.
 * </p>
 *
...
public final class GamepadDevice {
    ...
    /**
     * Left stick Y axis: -1.0 = full down, +1.0 = full up (Sushi convention).
     */
    ...
    /**
     * Right stick Y axis: -1.0 = full down, +1.0 = full up (Sushi convention).
     */
