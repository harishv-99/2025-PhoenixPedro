package edu.ftcsushi.fw.ftc.ui;
...
public final class MenuNavigator {
     ...
     */
    public void bind(CallbackBindings bindings, UiControls controls) {
     ...
     */
    public void bind(CallbackBindings bindings, UiControls controls, BooleanSupplier enabled) {
    ...
    private void bindOne(CallbackBindings bindings,
