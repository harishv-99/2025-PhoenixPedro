package edu.ftcsushi.fw.ftc.input;
 ...
 * <ul>
 *   <li>axes as {@link edu.ftcsushi.fw.core.source.ScalarSource}, and</li>
 *   <li>buttons as {@link edu.ftcsushi.fw.core.source.BooleanSource}.</li>
 * </ul>
 *
 * <p>There is <b>no global update step</b> for button edges. If you need edges, use
 * {@link edu.ftcsushi.fw.core.source.BooleanSource#risingEdge()} /
 * {@link edu.ftcsushi.fw.core.source.BooleanSource#fallingEdge()} (or use
 * {@link edu.ftcsushi.fw.input.binding.Bindings} which does this for you).</p>
 */
