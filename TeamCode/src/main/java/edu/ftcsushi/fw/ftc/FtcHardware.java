...
/**
 * FTC-boundary adapters that turn FTC SDK hardware devices into Sushi command channels.
 *
 * <p>This class intentionally exposes <b>command-only</b> outputs. If you need measurement or
 * feedback, use {@link FtcSensors} to obtain a Sushi source instead of trying to read back from
...
public final class FtcHardware {
    ...
    /**
     * Create a Sushi {@link PowerOutput} for a named FTC motor.
     *
     ...
     * @param direction logical forward direction for Sushi commands
    ...
    /**
     * Create a Sushi {@link PowerOutput} for an FTC motor instance.
     *
    ...
    /**
     * Create a Sushi {@link PowerOutput} for a named FTC continuous-rotation servo.
     *
    ...
    /**
     * Create a Sushi {@link PowerOutput} for an FTC continuous-rotation servo instance.
     *
    ...
    /**
     * Create a Sushi {@link PositionOutput} for a named FTC standard servo.
     *
    ...
    /**
     * Create a Sushi {@link PositionOutput} for an FTC standard servo instance.
     *
    ...
    /**
     * Create a Sushi {@link PowerLimitedPositionOutput} for a named FTC motor using
    ...
    /**
     * Create a Sushi {@link PowerLimitedPositionOutput} for an FTC motor instance using
     * {@link DcMotor.RunMode#RUN_TO_POSITION}.
     *
    ...
    /**
     * Create a Sushi {@link VelocityOutput} for a named FTC motor using
    ...
    /**
     * Create a Sushi {@link VelocityOutput} for an FTC motor instance using
     * {@link DcMotorEx#setVelocity(double)}.
     *
