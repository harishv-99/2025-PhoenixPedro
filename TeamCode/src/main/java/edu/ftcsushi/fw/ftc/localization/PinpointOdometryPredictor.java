 ...
 *
 * <p>This class is intentionally FTC-hardware-facing (it depends on the FTC SDK). Sushi robot
 ...
 * <p>The output pose and translational velocity use Sushi's current FTC season field frame:</p>
 * <ul>
 ...
 * which can be easy to confuse with Sushi's coordinate axes.</p>
 *
 * <p>To reduce mixups, Sushi uses <b>directional names</b> in {@link Config}:</p>
 * <ul>
...
public final class PinpointOdometryPredictor implements MotionPredictor, PoseResetter {
    ...
    /**
     * Sushi standard unit for field poses.
     */
