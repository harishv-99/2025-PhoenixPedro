...
public class FtcLimelightVisionLane implements AutoCloseable {
    ...
    /**
     * Sends Sushi field-frame yaw to Limelight for algorithms such as MegaTag 2.
     * Finite yaw is first wrapped to Sushi's canonical {@code (-pi, pi]} representative and only
