...
import edu.ftcsushi.fw.tools.tester.hardware.DcMotorPositionTester;
import edu.ftcsushi.fw.tools.tester.hardware.DcMotorPowerTester;
import edu.ftcsushi.fw.tools.tester.hardware.DcMotorVelocityTester;
import edu.ftcsushi.fw.tools.tester.hardware.NormalizedColorSensorTester;
...
/**
 * Registers the standard Sushi framework testers.
 *
 ...
 *       categories (for example Sushi).</li>
...
public final class StandardTesters {
     ...
     * {@code fw} portion of Sushi and has not built a robot-specific tester menu yet.</p>
     */
    ...
    private static edu.ftcsushi.fw.ftc.localization.FtcOdometryAprilTagLocalizationLane.Config buildCorrectedLocalizationConfig(String hardwareName) {
        edu.ftcsushi.fw.ftc.localization.FtcOdometryAprilTagLocalizationLane.Config cfg =
                edu.ftcsushi.fw.ftc.localization.FtcOdometryAprilTagLocalizationLane.Config.defaults();
        cfg.predictor = pinpointConfig(hardwareName);
        cfg.estimation.correctedEstimatorMode = edu.ftcsushi.fw.ftc.localization.FtcOdometryAprilTagLocalizationLane.GlobalEstimatorMode.FUSION;
        cfg.estimation.correctionSource.mode = edu.ftcsushi.fw.ftc.localization.FtcOdometryAprilTagLocalizationLane.CorrectionSourceMode.APRILTAG_POSE;
