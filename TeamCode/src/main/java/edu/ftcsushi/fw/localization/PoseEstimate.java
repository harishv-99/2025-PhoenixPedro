 ...
 *
 * <p>Sushi field-centric poses follow the <b>FTC Field Coordinate System</b> for the current game.
 * Importantly, the <b>meaning of the X/Y axes is season-dependent</b> (square vs diamond vs inverted
 * square). Sushi therefore avoids hardcoding “+X is …” or “+Y is …” in core pose types.</p>
 *
