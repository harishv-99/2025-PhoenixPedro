...
The coordinate system in which a pose or vector is expressed. Sushi robot frame is right-handed:
...
[Cheat sheet](<Sushi Cheat Sheet.md>) · [Reference index](<README.md>) · [Docs home](<../README.md>)
