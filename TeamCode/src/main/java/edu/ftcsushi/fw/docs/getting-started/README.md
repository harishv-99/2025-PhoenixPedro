...
Start with [Sushi in one picture](<Framework Overview.md>). It follows one Starter button through
...
[your first Sushi robot code](<First Sushi Robot Code.md>). It copies the one canonical Starter
...
[Build and run Sushi](<Build and Run.md>) explains project setup and software verification. When
...
**First-contact guide:** [Sushi in one picture](<Framework Overview.md>)
