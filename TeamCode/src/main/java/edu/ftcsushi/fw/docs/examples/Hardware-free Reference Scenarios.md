...
| Do finished feed commands prove departure? | `ReferenceLauncherMechanism` + paired wheels, inventory, Plants, and Task | **Advanced:** [feedback-confirmed feeding](<../advanced/Feedback-confirmed Feeding.md>) | staging, loaded-wheel behavior, safe interruption, and actual launch |
