...
| Do named claw positions map through safe endpoints? | `BasicClawMechanism` + servo Plant | [Named claw](<../build/Named Claw.md#software-checkpoint-normalized-half-derives-from-two-endpoints>) | linkage clearance and arrival |
| Does switch/encoder evidence drive homing and status? | `BasicLiftMechanism` + Tasks + Plant | [Referenced lift](<../build/Referenced Lift.md#software-checkpoint-authored-switch-evidence-controls-homing>) | switch, scale, direction, and travel |
