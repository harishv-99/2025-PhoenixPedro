...
import edu.ftcphoenix.fw.actuation.PositionPlantTuning;
import edu.ftcphoenix.fw.actuation.ScalarRange;
import edu.ftcphoenix.fw.actuation.StandardControlTuning;
import edu.ftcphoenix.fw.actuation.StandardControlTunings;
import edu.ftcphoenix.fw.core.time.LoopClock;
import edu.ftcphoenix.fw.ftc.FtcMotorControllers;
import edu.ftcphoenix.fw.ftc.FtcMotorPidfConfiguration;
import edu.ftcphoenix.fw.ftc.FtcMotorPositionControl;
import edu.ftcphoenix.fw.ftc.FtcMotorVelocityControl;
...
final class ControlTuningAdapters {
    ...
    static ControlTuningModel.Session claimVelocity(Plant plant) {
        ...
        try {
            ...
            IllegalArgumentException combined = new IllegalArgumentException(
                    "Velocity control tuning supports an exact Phoenix standard-regulated Plant "
    ...
    static ControlTuningModel.Session claimPosition(PositionPlant plant) {
        ...
        try {
            ...
            IllegalArgumentException combined = new IllegalArgumentException(
                    "Position control tuning supports an exact Phoenix standard-regulated "
    ...
    private static final class StandardSession implements ControlTuningModel.Session {
        ...
        public String topology() {
            ...
            return "PHOENIX_STANDARD/" + topology.domain() + "/"
