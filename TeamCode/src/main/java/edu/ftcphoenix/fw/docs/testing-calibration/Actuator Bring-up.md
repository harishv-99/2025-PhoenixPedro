...
one ordinary Phoenix tool for answering two hardware questions:
...
`PhoenixActuatorBringUp`. Copy it deliberately into the data-only robot configuration or mechanism
