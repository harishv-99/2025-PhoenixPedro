package edu.ftcphoenix.robots.examples.pedro.autonomous;
...
public final class BasicPedroAutoPaths {
    ...
    /** Returns the fixed practice route to the robot composition root; callers must not mutate it. */
    public PathChain practiceRoute() {
