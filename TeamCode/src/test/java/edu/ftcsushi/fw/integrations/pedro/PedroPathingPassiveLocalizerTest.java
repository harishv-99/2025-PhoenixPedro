...
public final class PedroPathingPassiveLocalizerTest {
    ...
    public void repeatedPreHeartbeatStartAndCorrectionRebasesPreservePhysicalVelocityAndHeading() {
        ...
        assertEquals(6.0, access.sample.sushiFieldVelocityXInchesPerSec, EPSILON);
        assertEquals(-2.0, access.sample.sushiFieldVelocityYInchesPerSec, EPSILON);
        ...
        access.sample = sampled(
                ...
                access.sample.sushiFieldToRobotPose,
                6.0,
                -2.0,
                0.75,
                9.0
    ...
    private static final class FakePredictorAccess
        ...
        public void setPose(Pose2d sushiFieldToRobotPose) {
            setPoseCount++;
            rebase(sushiFieldToRobotPose);
        }

        void rebase(Pose2d sushiFieldToRobotPose) {
            sample = new PedroPathingPassiveLocalizer.Sample(
                    ...
                    sample.cycle,
                    sample.timestamp,
                    sample.sushiFieldVelocityXInchesPerSec,
                    sample.sushiFieldVelocityYInchesPerSec,
