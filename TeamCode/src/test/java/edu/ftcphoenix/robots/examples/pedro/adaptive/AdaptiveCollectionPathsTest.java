...
public final class AdaptiveCollectionPathsTest {
    ...
    @Test
    public void selectedAndUnavailableCollectionUseLivePoseAndExplicitPhoenixTargets()
            throws Exception {
        ...
        assertPath(
                ...
                config.fieldTransform.phoenixFieldToPedroPose(
    ...
    public void returnSamplesLaterPoseAndOwnerRetainsDefensiveConfigSnapshot() throws Exception {
        ...
        assertPath(
                ...
                PedroFieldTransform.decodeInvertedFtc().phoenixFieldToPedroPose(
