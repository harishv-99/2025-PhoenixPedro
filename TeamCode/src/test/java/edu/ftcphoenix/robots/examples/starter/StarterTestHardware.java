...
/** Shared package-private FTC probes for the focused Starter suites. */
final class StarterTestHardware {

    private StarterTestHardware() {
        // Test fixture.
    }

    static <T extends FtcRobotOpMode> T prepare(
            T mode,
    ...
    static HardwareMapProbe fullTeleOpHardware(StarterProfile profile) {
        return fullTeleOpHardware(profile, null);
    }

    static HardwareMapProbe fullTeleOpHardware(StarterProfile profile, List<String> events) {
    ...
    static final class HardwareMapProbe extends HardwareMap {
        ...
        HardwareMapProbe(List<String> events) {
            super(null, null);
            this.events = events;
        }
    ...
    static final class MotorProbe implements InvocationHandler {
    ...
    static final class TelemetryProbe implements InvocationHandler {
        ...
        TelemetryProbe(List<String> events) {
            this.events = events;
        }
        ...
        int dataRowsAtLastUpdate() {
            return dataRowsAtLastUpdate;
        }

        List<String> lastFrameKeys() {
            return lastFrameKeys;
        }

        Object dataValue(String key) {
