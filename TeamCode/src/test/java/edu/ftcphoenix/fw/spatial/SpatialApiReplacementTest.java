...
import edu.ftcphoenix.fw.drive.guidance.GoToPoseTasks;
...
public final class SpatialApiReplacementTest {
    ...
    private static final String SPATIAL_PACKAGE = "edu.ftcphoenix.fw.spatial.";
    ...
    private static final class NoPoseEstimator implements AbsolutePoseEstimator {
        ...
        public PoseEstimate getEstimate() {
            return PoseEstimate.noPose(edu.ftcphoenix.fw.core.time.LoopTimestamp.unavailable());
        }
    }
